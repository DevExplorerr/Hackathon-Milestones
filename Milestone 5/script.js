document.addEventListener("DOMContentLoaded", function () {
    ...
    var downloadButtonContainer = document.querySelector(".download");
    var downloadButton = downloadButtonContainer.querySelector("button");
    ...
    form.addEventListener("submit", function (event) {
        ...
        // Show the download button after resume is generated
