document.addEventListener("DOMContentLoaded", () => {
    ...
    const downloadButtonContainer = document.querySelector(".download") as HTMLDivElement;
    const downloadButton = downloadButtonContainer.querySelector("button") as HTMLButtonElement;
